...
public:
	...
	void SetBorder(BOOL bBorder)		{m_Border = bBorder;};
	void SetBkgndColor(COLORREF nomal, COLORREF down, COLORREF over_sel, COLORREF disable);
...
protected:
	...
	COLORREF	m_colNomal, m_colDown, m_colOver, m_colDisable;
